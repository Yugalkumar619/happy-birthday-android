...
import com.app.happy_birthday.databinding.LvItemBhajanListBinding
...
class BhajanListAdapter constructor() : RecyclerView.Adapter<BhajanListAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int):MyViewHolder{
        val binding: LvItemBhajanListBinding = LvItemBhajanListBinding.inflate(
...
//        holder.binding.txtBhajanTitle.text = a?.title
    ...
    class MyViewHolder(var binding: LvItemBhajanListBinding) :
